...
class Node(object):
    ...
    """
    def __init__(self, id=None, hostname=None, name=None, role=None, cpu_model=None, os_image=None, kernel_version=None, docker_version=None, kubelet_version=None, nvidia_driver=None, cpus=None, mem=None, gpus_allocatable=None, gpus=None):
        """
