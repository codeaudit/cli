...
class Job(object):
    ...
    """
    def __init__(self, id=None, short_id=None, root=None, parent=None, previous_job=None, name=None, kind=None, role=None, state=None, desired_state=None, reason=None, message=None, created_at=None, started_at=None, state_changed_at=None, finished_at=None, cpus=None, mem=None, gpus=None, image=None, service_name=None, service_ports=None, environment=None, commands=None, children=None, changeset=None):
        """
    ...
    def changeset(self):
        """
        Gets the changeset of this Job.


        :return: The changeset of this Job.
        :rtype: Changeset
        """
    ...
    def changeset(self, changeset):
        """
        Sets the changeset of this Job.


        :param changeset: The changeset of this Job.
        :type: Changeset
        """
