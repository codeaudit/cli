...
class Changeset(object):
    ...
    """
    def __init__(self, id=None, revision=None, command=None, required_gpus=None, required_cpus=None, required_mem=None, image_name=None, config=None, created_at=None, message=None):
        """
