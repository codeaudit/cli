...
class Training(object):
    ...
    """
    def __init__(self, id=None, short_id=None, state=None, state_changed_at=None, created_at=None, started_at=None, finished_at=None, framework=None, framework_details=None, image=None, run_commands=None, max_parallel_experiments=None, active_job_count=None, jobs=None, changeset=None, experiments=None):
        """
    ...
    @property
    def max_parallel_experiments(self):
        """
        Gets the max_parallel_experiments of this Training.


        :return: The max_parallel_experiments of this Training.
        :rtype: int
        """
        return self._max_parallel_experiments

    @max_parallel_experiments.setter
    def max_parallel_experiments(self, max_parallel_experiments):
        """
        Sets the max_parallel_experiments of this Training.


        :param max_parallel_experiments: The max_parallel_experiments of this Training.
        :type: int
        """
    ...
    def experiments(self):
        """
        Gets the experiments of this Training.


        :return: The experiments of this Training.
    ...
    def experiments(self, experiments):
        """
        Sets the experiments of this Training.


        :param experiments: The experiments of this Training.
