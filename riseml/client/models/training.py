...
class Training(object):
    ...
    """
    def __init__(self, id=None, short_id=None, state=None, state_changed_at=None, created_at=None, started_at=None, finished_at=None, framework=None, framework_details=None, image=None, run_commands=None, concurrent_experiments=None, active_job_count=None, jobs=None, changeset=None, experiments=None):
        """
    ...
    def concurrent_experiments(self):
        """
        Gets the concurrent_experiments of this Training.


        :return: The concurrent_experiments of this Training.
        :rtype: int
        """
    ...
    def concurrent_experiments(self, concurrent_experiments):
        """
        Sets the concurrent_experiments of this Training.


        :param concurrent_experiments: The concurrent_experiments of this Training.
        :type: int
        """
