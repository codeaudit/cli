...
class Experiment(object):
    ...
    """
    def __init__(self, id=None, short_id=None, state=None, state_changed_at=None, created_at=None, started_at=None, finished_at=None, framework=None, framework_config=None, image=None, run_commands=None, concurrency=None, params=None, result=None, type=None, jobs=None, project=None, user=None, children=None):
        """
